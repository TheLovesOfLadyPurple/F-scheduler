...
def main():
    ...
    sampler = UniPCSampler(pipe, model_closure=model_closure, steps=opt.steps, guidance_scale=opt.scale,is_high_resoulution=False)
    ...
    sample_path = os.path.join(outpath, f"samples-unipc-{opt.skip_type}")
